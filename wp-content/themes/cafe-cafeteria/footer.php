<footer>
  <div class="container">
            ...
            <div class="container">
              <div class="row sidebar-area footer-area">
                <div id="categories-2" class="col-lg-3 col-md-6 widget_categories wow rollIn">
                    <h4 class="title"><?php esc_html_e('Categories', 'cafe-cafeteria'); ?></h4>
                    <ul>
                        <?php
                ...
                <div id="pages-2" class="col-lg-3 col-md-6 widget_pages wow rollIn">
                    <h4 class="title"><?php esc_html_e('Pages', 'cafe-cafeteria'); ?></h4>
                    <ul>
                        <?php
                        wp_list_pages(array(
                            'title_li' => '',
                ...
                <div id="archives-2" class="col-lg-3 col-md-6 widget_archive wow rollIn">
                    <h4 class="title"><?php esc_html_e('Archives', 'cafe-cafeteria'); ?></h4>
                    <ul>
                        <?php
                ...
                <div id="calendar" class="col-lg-3 col-md-6 widget_calendar wow rollIn">
                  <h4 class="title"><?php esc_html_e('Calendar', 'cafe-cafeteria'); ?></h4>
                  <?php get_calendar(); ?>
                </div>
              </div>
            </div>
    ...
    <div class="copyright">
          ...
          <div class="copy-text">
            ...
            <?php
              if (!get_theme_mod('cafe_cafeteria_footer_text') ) { ?>
                <a href="<?php echo esc_url('https://www.misbahwp.com/products/free-cafe-wordpress-theme'); ?>" target="_blank">
            ...
            <?php if ( get_theme_mod('cafe_cafeteria_copyright_enable', true) == true ) : ?>
              ...
              <a href="<?php echo esc_url('https://wordpress.org'); ?>" rel="generator"><?php  /* translators: %s: WordPress */  printf( esc_html__( ' | Proudly powered by %s', 'cafe-cafeteria' ), 'WordPress' ); ?></a>
            <?php endif; ?>
          </p>
          </div>
        </div>
      ...
      <?php $cafe_cafeteria_scroll_top_icon = get_theme_mod( 'cafe_cafeteria_scroll_top_icon', 'dashicons dashicons-arrow-up-alt' ); ?>
        <?php if ( get_theme_mod('cafe_cafeteria_scroll_enable_setting', true) == true ) : ?>
          <div class="scroll-up">
              <a href="#tobottom"><span class="dashicons dashicons-<?php echo esc_attr( $cafe_cafeteria_scroll_top_icon ); ?>"></span></a>
          </div>
      <?php endif; ?>
</footer>
